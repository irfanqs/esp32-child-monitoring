...
#include "tflite-model/tflite_learn_29_compiled.h"

#include "edge-impulse-sdk/classifier/ei_model_types.h"
#include "edge-impulse-sdk/classifier/inferencing_engines/engines.h"

const char* ei_classifier_inferencing_categories[] = { "Fall", "Other" };

uint8_t ei_dsp_config_28_axes[] = { 0, 1, 2 };
const uint32_t ei_dsp_config_28_axes_size = 3;
ei_dsp_config_spectral_analysis_t ei_dsp_config_28 = {
    28, // uint32_t blockId
...
ei_model_dsp_t ei_dsp_blocks[ei_dsp_blocks_size] = {
    { // DSP block 28
        ...
        (void*)&ei_dsp_config_28, // pointer to config struct
        ei_dsp_config_28_axes, // array of offsets into the input stream, one for each axis
        ei_dsp_config_28_axes_size, // number of axes
        1, // version
        nullptr, // factory function
    }
};
const ei_config_tflite_eon_graph_t ei_config_tflite_graph_29 = {
    .implementation_version = 1,
    .model_init = &tflite_learn_29_init,
    .model_invoke = &tflite_learn_29_invoke,
    .model_reset = &tflite_learn_29_reset,
    .model_input = &tflite_learn_29_input,
    .model_output = &tflite_learn_29_output,
};


const ei_learning_block_config_tflite_graph_t ei_learning_block_config_29 = {
    .implementation_version = 1,
    ...
    .quantized = 1,
    .compiled = 1,
    .graph_config = (void*)&ei_config_tflite_graph_29
};

const ei_learning_block_config_anomaly_kmeans_t ei_learning_block_config_30 = {
    .implementation_version = 1,
...
const uint32_t ei_learning_block_29_inputs[1] = { 28 };
const uint8_t ei_learning_block_29_inputs_size = 1;
const uint32_t ei_learning_block_30_inputs[1] = { 28 };
const uint8_t ei_learning_block_30_inputs_size = 1;
const ei_learning_block_t ei_learning_blocks[ei_learning_blocks_size] = {
    {
        29,
        false,
        &run_nn_inference,
        (void*)&ei_learning_block_config_29,
        EI_CLASSIFIER_IMAGE_SCALING_NONE,
        ei_learning_block_29_inputs,
        ei_learning_block_29_inputs_size,
        2
    },
    {
        30,
        false,
        &run_kmeans_anomaly,
        (void*)&ei_learning_block_config_30,
        EI_CLASSIFIER_IMAGE_SCALING_NONE,
        ei_learning_block_30_inputs,
        ei_learning_block_30_inputs_size,
        1
    },
};
...
const ei_impulse_t impulse_576260_0 = {
    .project_id = 576260,
    .project_owner = "Fransiskus Sitompul",
    .project_name = "Fall Detection Model",
    .impulse_id = 6,
...
ei_impulse_handle_t impulse_handle_576260_0 = ei_impulse_handle_t( &impulse_576260_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_576260_0;
