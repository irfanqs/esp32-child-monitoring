...
#define EI_CLASSIFIER_PROJECT_ID                 539473
#define EI_CLASSIFIER_PROJECT_OWNER              "Fransiskus Sitompul"
#define EI_CLASSIFIER_PROJECT_NAME               "masonkresge's-falldetector"
