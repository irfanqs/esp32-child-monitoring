...
const int pushButtonPin = 32;         // Define the pin number for the push button (connected to pin 32)
const int ledPin = 12;                // Define the pin number for the LED (connected to pin 12)
